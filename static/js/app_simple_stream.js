...
let silenceDuration = 1500; // Durée de silence avant arrêt (ms)
...
async function processAudio() {
    try {
        ...
        // Étape 2: GPT STREAMING - Texte apparaît en temps réel
        updateStatus('🤖', 'L\'agent réfléchit...', 'processing');
        addLog('💭 Streaming de la réponse...', 'info');
        ...
        // Étape 3: Générer l'audio du texte COMPLET
        updateStatus('🔊', 'Génération audio...', 'processing');
        addLog('Envoi à ElevenLabs...', 'info');
        ...
        addLog('✓ Audio généré, lecture...', 'success');
...
addLog('🎉 Application prête ! Mode streaming activé pour vitesse max', 'success');
